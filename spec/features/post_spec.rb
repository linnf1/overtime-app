...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: "nonauth@example.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "4444444444")
  ...
  describe 'new' do
    it 'has a link from the homepage' do
      emp = Employee.create(first_name: 'Test', last_name: 'Emplyoee', email: "employee@example.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "4444444444")
